  ...
  return (
    <header className="w-full flex justify-center items-center flex-col">
      ...
      items-center w-full mb-10 pt-3'>
        ...
        <button type='button'
        onClick={()=> window.open('https://github.com/Manaswini123456/GPT-AI')} className='black_btn'>
          Github
        </button>
      </nav>
      ...
      <h2 className='desc'>
        Simplify your reading with Summize, an open-source article summarizer that trnasforms
